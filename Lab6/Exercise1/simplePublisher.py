...
if __name__ == "__main__":
	...
	while (a < 1200):
		...
		test.myPublish ('/this/is/my/first/topic', message)
		test.myPublish ('/this/is/my/second/topic', message + ' Second')
		test.myPublish ('/this/is/my/first/message', message + ' Message')	
		a += 1
		time.sleep(1)
